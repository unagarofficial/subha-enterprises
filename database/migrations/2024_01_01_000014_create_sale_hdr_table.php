...
return new class extends Migration
{
    ...
    {
        Schema::create('sale_hdr', function (Blueprint $table) {
            ...
            $table->unsignedInteger('ord_no')->nullable();
            $table->tinyInteger('sale_type')->default(1);
            $table->unsignedSmallInteger('fin_year_id');
            $table->timestamps();

            $table->primary(['br_code', 'inv_no', 'sale_type']);
