...
<head>
    ...
    <title>500 — Server Error | Subha Enterprises</title>
    ...
    <style>
        ...
        .error-code { font-size: 6rem; font-weight: 800; color: #fd7e14; line-height: 1; }
...
<body>
    <div class="error-box">
        ...
        <p class="error-msg">Something went wrong on our end. Please try again in a moment or contact support if the problem persists.</p>
