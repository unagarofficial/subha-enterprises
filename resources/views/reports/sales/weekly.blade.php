...
<div class="d-flex justify-content-between align-items-center mb-3 no-print">
    <h5 class="mb-0"><i class="bi bi-calendar3-week me-1 text-primary"></i> Weekly Sales Report</h5>
</div>
...
<div class="card mb-3 no-print">
    ...
    <div class="card-body py-2">
        ...
        @endif
        <form method="GET" action="{{ route('reports.sales.weekly') }}" id="filterForm">
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-4 d-flex gap-2">
                    ...
                    <a href="{{ route('reports.sales.weekly.export') }}?{{ http_build_query(request()->query()) }}"
...
<div class="d-none d-print-block text-center mb-3">
    <h4 class="mb-0">Weekly Sales Report</h4>
...
<div class="card">
    <div class="card-header py-2 d-flex justify-content-between no-print">
        <span><i class="bi bi-table me-1"></i>Weekly Summary</span>
    ...
    <div class="card-body p-0">
        ...
        <table class="table table-bordered rpt-table mb-0">
            ...
            <tr>
                <td>
                    <span class="day-badge">{{ $day->format('l') }}</span>
                </td>
...
@push('scripts')
<script>
// Auto-set week_to = week_from + 6 when week_from changes (only if week_to wasn't manually set)
