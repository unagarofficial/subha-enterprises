...
.supplier-header { background:#fce8e8; font-weight:600; font-size:0.78rem; color:#7b1c1c; padding:4px 8px; }
@media print {
...
<div class="d-flex justify-content-between align-items-center mb-3 no-print">
    <h5 class="mb-0"><i class="bi bi-arrow-return-left me-1 text-danger"></i> Purchase Return Report</h5>
</div>
...
<div class="card mb-3 no-print">
    ...
    <div class="card-body py-2">
        ...
        @endif
        <form method="GET" action="{{ route('reports.purchase.returns') }}">
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-2">
                    ...
                    <select name="rtn_type" class="form-select form-select-sm">
                        <option value="" {{ $rtnType === '' ? 'selected' : '' }}>All Types</option>
                        <option value="Covering" {{ $rtnType === 'Covering' ? 'selected' : '' }}>Covering</option>
                        <option value="Plating"  {{ $rtnType === 'Plating'  ? 'selected' : '' }}>Plating</option>
                    </select>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-2 d-flex gap-2 flex-wrap">
                    ...
                    <a href="{{ route('reports.purchase.returns.export') }}?{{ http_build_query(request()->query()) }}"
