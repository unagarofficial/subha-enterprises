...
@section('title', 'Purchase Return #'.$hdr->inv_no)
...
<div class="print-header">
    ...
    @endif
    <h5 class="mt-2 mb-0" style="letter-spacing:2px; font-size:0.95rem;">PURCHASE RETURN NOTE</h5>
</div>

{{-- ── Meta + Supplier ── --}}
<div class="row mb-3">
    <div class="col-6">
        <div class="section-title mb-1">Return To (Supplier)</div>
    ...
    <div class="col-6 text-end">
        <table class="ms-auto" style="font-size:0.82rem;">
            ...
            <tr><td class="pe-3 text-muted">Return Type</td><td><strong>{{ $hdr->rtn_type }}</strong></td></tr>
        </table>
    </div>
</div>
...
{{-- ── Covering / Plating specific note ── --}}
@if($hdr->rtn_type === 'COVERING')
<div class="mt-2" style="font-size:0.78rem; border:1px dashed #999; padding:4px 8px; border-radius:4px;">
    <strong>Type: COVERING</strong> — Goods returned as Covering material
</div>
@elseif($hdr->rtn_type === 'PLATING')
<div class="mt-2" style="font-size:0.78rem; border:1px dashed #999; padding:4px 8px; border-radius:4px;">
    <strong>Type: PLATING</strong> — Goods returned as Plating material
</div>
@endif
...
<div class="sign-area d-flex justify-content-between">
    <div>
        <div class="sign-line">Supplier's Acknowledgement</div>
    </div>
    <div class="text-end">
