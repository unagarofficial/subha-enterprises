...
@section('title', 'Estimation Invoice #'.$hdr->inv_no)
...
<div class="print-header">
    ...
    @endif
    <h5 class="mt-2 mb-0" style="letter-spacing:2px; font-size:0.95rem;">ESTIMATION INVOICE</h5>
    <small class="text-muted" style="font-size:0.72rem;">(This is not a Tax Invoice)</small>
</div>

{{-- ── Invoice Meta + Party ── --}}
<div class="row mb-3">
    <div class="col-6">
        <div class="section-title mb-1">Party Details</div>
        ...
        @if($hdr->party_state){{ $hdr->party_state }}<br>@endif
...
<table class="inv-table">
    <thead>
        <tr>
            ...
            <th style="width:130px">Narration</th>
        </tr>
    </thead>
    <tbody>
        @foreach($dtls as $d)
        <tr>
            ...
            <td>{{ $d->mat_name }} <small style="color:#888;">({{ $d->mat_code }})</small></td>
