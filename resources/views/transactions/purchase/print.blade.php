...
@section('title', 'Purchase Invoice #'.$hdr->inv_no)
...
<div class="print-header">
    ...
    @endif
    <h5 class="mt-2 mb-0" style="letter-spacing:2px; font-size:0.95rem;">PURCHASE INVOICE</h5>
</div>

{{-- ── Invoice Meta + Supplier ── --}}
<div class="row mb-3">
    <div class="col-6">
        <div class="section-title mb-1">Bill From (Supplier)</div>
